...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_frames", type=int, default=9, help="Number of steps for the inference process")
    ...
    parser.add_argument("--fps", type=int, default=4, help="Number of steps for the inference process")
