...
edit_prompt = "A photo of a horse"
...
show_images(np.asarray(image), res, init_prompt, edit_prompt,'/home/whl/workspace/sd3/Guide-and-Rescale/result_ddim/horse_only_3e7_5e2.jpg')
pdb.set_trace()
