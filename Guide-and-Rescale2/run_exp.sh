...
yaml_file="/home/cby/cogvideo_code/Guide-and-Rescale2/configs/ours_nonstyle_best_cogvideo.yaml"
python_file="/home/cby/cogvideo_code/Guide-and-Rescale2/guide_and_rescale_cogvideo.py"  # 替换成实际的 Python 文件路径

# 设置 self_attn_gs 和 app_gs 的值范围
self_attn_gs_values=($(seq 1000 1000 15000))   # 设定自定义的 self_attn_gs 值
