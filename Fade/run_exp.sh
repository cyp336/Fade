...
yaml_file="/home/cby/cogvideo_code/Guide-and-Rescale/configs/ours_nonstyle_best_cogvideo.yaml"
python_file="/home/cby/cogvideo_code/Guide-and-Rescale/guide_and_rescale_cogvideo.py"  # 替换成实际的 Python 文件路径
